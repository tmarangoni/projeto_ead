...
$usuario->setIdMedico($medico);
    ...
    foreach($usuario->findInfo() as $key => $value)
    {
        ...
        echo ("<form method='post' action='../../controller/medico/dados_usuario' name='alterar_dados'>");
        echo ("<fieldset>");
        ...
        echo ("</td>");
        echo ("<td align=\"left\">");
        echo ("<input type=\"text\" name=\"crm\" size=\"9\" maxlength=\"9\"  class=\"form-control bg-light small\" value='$value->crm' required>");
        echo ("</td>");
        echo ("</tr>");
        ...
        echo ("<tr>
           ...
           <td align=\"left\">
           <select name=\"categoria\" class=\"form-control bg-light \" >
