    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Cadastrar Médicos</h1>
                ...
                <form id="form_cadastro_medico" class="" action="" method="POST">
                    ...
                    <br/>
                    <input type="text" required name="crm" class="form-control form-control-user" placeholder="CRM"/>
                    <br/>
                    <select name="categoria" class="form-control form-control-user" >
                        <option value="">Escolha uma especialização</option>
                    ...
                    <br/>
                    <button type="submit" class="btn_login btn btn-primary btn-user btn-block">Cadastrar</button>
                </form>
