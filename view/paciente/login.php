              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <form class="user" id="form_login_paciente" action="" method="post">
                        <div class="form-group">
                        <input type="cpf" required name="cpf" class="form-control form-control-user" placeholder="Informe o CPF"/></label>
                        </div>
                        <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="cadastro" id="criarUser">Criar uma Conta!</a>
                  </div>
                </div>
              </div>
            </div>
